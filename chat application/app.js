...
const RoseSelectorBtn = document.querySelector('#Rose-selector')
...
const updateMessageSender = (name) => {
  ...
  if (name === 'Jack') {
    ...
    RoseSelectorBtn.classList.remove('active-person')
  }
  if (name === 'Rose') {
    RoseSelectorBtn.classList.add('active-person')
...
RoseSelectorBtn.onclick = () => updateMessageSender('Rose')
